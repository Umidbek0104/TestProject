...
<head>
    ...
    <title>Admin Panel - Post Qo‘shish</title>
...
<div class="sidebar-content">
    ...
    <div class="main-content">
        <h3 class="text-primary fw-bold mb-4">
            <i class="fas fa-thumbtack me-2"></i> Yangi Post Qo‘shish
        </h3>

        <div class="card">
            <div class="card-header">
                <i class="fas fa-plus-circle me-2"></i> Post Ma'lumotlari
            </div>
            <div class="card-body">
                <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <label for="title" class="form-label">Sarlavha (Title)</label>
                    <input
                        type="text"
                        id="title"
                        name="title"
                    ...
                    <label for="video_url" class="form-label">Video URL (ixtiyoriy)</label>
                    <input
                        type="text"
                        id="video_url"
                        name="video_url"
