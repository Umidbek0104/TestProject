...
<head>
    ...
    <title>Admin Panel - Kategoriyalar Ro'yxati</title>
    ...
    <div class="main-content">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('admin.category.create') }}" class="button blue" style="font-size:14px;">
                ...
                <table>
                    ...
                    @foreach($categories as $category)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.category.edit', $category->id) }}" class="button blue">
                                    <i class="fas fa-edit"></i> Tahrirlash
                                </a>
                            </td>
                            <td>
                                <form action="{{ route('admin.category.delete', $category->id) }}" method="POST" onsubmit="return confirm('Ushbu kategoriyani o‘chirishni xohlaysizmi?');" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @if($categories->isEmpty())
                        <tr>
                            <td colspan="6" style="text-align:center; color:#777;">Kategoriyalar mavjud emas</td>
                        </tr>
                    @endif
                    </tbody>
                </table>
